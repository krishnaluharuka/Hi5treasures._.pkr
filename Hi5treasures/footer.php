...
<body>
  ...
  <footer class="contact">
    ...
    <p class="text-center bg-light py-3"><a href="https://github.com/krishnaluharuka/Hi5treasures._.pkr" class="text-decoration-none text-dark"> By Krishna Luharuka | All Rights Reserved</a></p>
  </footer>
</body>
