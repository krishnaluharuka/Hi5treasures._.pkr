...
<body class="bg">
    <div class="container">
        <div class="row d-flex justify-content-center align-items-center">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 border shadow p-3 my-3">
...
if (isset($_POST['user_register'])) {
    ...
    if ($rows_count > 0) {
        ...
        user_address,user_mobile,user_type) values ('$user_username','$user_email','$hash_password',
        '$user_image','$user_ip','$user_address','$user_contact','$user_type')";
